...
class StateTransition(object):
    ...
    def __call__(self, func: Callable) -> Callable:
        def wrapper(
            ...
            new_global_states = func(func_obj, global_state)
            new_global_states = [
...
class Instruction:
    ...
    @StateTransition()
    def call_bak(self, global_state: GlobalState) -> List[GlobalState]:
        """
    ...
    @StateTransition()
    def staticcall_bak(self, global_state: GlobalState) -> List[GlobalState]:
        """
