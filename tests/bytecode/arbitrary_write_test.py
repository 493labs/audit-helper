...
def test_arbitrary_write():
    solidity_contract = get_contract(None, './tests/bytecode/examples/arbitrary_write.sol','ArbitraryWrite')
    assert arbitrary_write_check(solidity_contract.disassembly) == True

def test_no_arbitrary_write():
    solidity_contract = get_contract(None, './tests/bytecode/examples/arbitrary_write.sol','NoArbitraryWrite')
